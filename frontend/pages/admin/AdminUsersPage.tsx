                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div>
                     ...
                     <div>
                        ...
                        <input {...register('username', { required: 'El usuario es requerido', minLength: { value: 3, message: 'Mínimo 3 caracteres' } })} className={inputClasses} placeholder="Ej: admin" />
                     ...
                     <div>
                        ...
                        <input 
                            ...
                            placeholder="Ej: TuContraseñaSegura123" 
                        />
